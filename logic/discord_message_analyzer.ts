...
export class DiscordMessageAnalyzer {
     ...
     */
    analyze(mes: string, server_id: string, message_user_id: string, user_id: string): Promise<void> {
        return new Promise<void>((resolve, reject) => {
            ...
            if (DiscordMessageAnalyzer.check_server_start(this.message)) {
                logger.info(`target message is server start request. message = ${this.message}`);
                ...
                logger.info(`target message is get public ip. message = ${this.message}`);
                ...
                logger.info(`target message is stop server. message = ${this.message}`);
     ...
     * @returns 
     */
    static check_server_start(mes: string): boolean {
     ...
     * @returns 
     */
    static check_get_public_ip(mes: string): boolean {
     ...
     * @returns 
     */
    static check_stop_start(mes: string): boolean {
